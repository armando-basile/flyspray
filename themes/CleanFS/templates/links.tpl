...
if ($user->isAnon()):
	...
	?><li>
		<a id="optionslink"<?php if ($do=='admin'): ?> class="active"<?php endif; ?> href="<?php echo Filters::noXSS(CreateURL('admin', 'prefs')); ?>" title="<?php echo Filters::noXSS(L('admintoolbox')); ?>"><i class="fa fa-gears fa-lg"></i>&nbsp;<?php echo Filters::noXSS(L('admintoolbox')); ?></a>
	</li><?php
	endif;
	?><li>
		<a id="logoutlink" href="<?php echo Filters::noXSS(CreateURL('logout', null)); ?>"
		accesskey="l" title="<?php echo Filters::noXSS(L('logout')); ?>"><i class="fa fa-power-off fa-lg"></i>&nbsp;<?php echo Filters::noXSS(L('logout')); ?></a>
	</li><?php
